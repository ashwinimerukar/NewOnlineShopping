...
@Component({
  selector: 'app-review-new-data',
  templateUrl: './review-new-data.component.html',
  styleUrls: ['./review-new-data.component.scss']
})
export class ReviewNewDataComponent implements OnInit {
